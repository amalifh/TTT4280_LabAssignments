...
/* RPi PIN ASSIGNMENTS */
#define MISO1 27    // ADC 1 MISO (GPIO pin number)
#define MISO2 26    // ADC 2 MISO (GPIO pin number)
#define MISO3 25    // ADC 3 MISO (GPIO pin number)
#define MISO4 24    // ADC 4 MISO (GPIO pin number)
#define MISO5 23    // ADC 5 MISO (GPIO pin number)
...
#define SPI_SS 21  // GPIO for slave select (GPIO 15).
#define CLK 22      // GPIO for SPI clock (GPIO 16).
